...
class MailChangeViewModel: ObservableObject {
    
    @Published var num_tel: String = ""
    @Published var newPassword: String = ""

    func send() {
        let apiUrl = URL(string: "http://localhost:3002/password/forgotpasswordfinal")!
        
        let requestBody = Request(num_tel: num_tel,newPassword: newPassword)
